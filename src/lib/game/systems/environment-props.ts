...
export const PHASE_ONE_ENVIRONMENT_ART: EnvironmentArtDefinition[] = [
  { key: GAME_ASSETS.buildings.policeBase.key, x: 6.4, y: 6.6, scale: 0.152, depth: -30, zoneId: 'base', alpha: 0.92, originY: 0.78, footprintWidth: 330, footprintHeight: 116, footprintOffsetY: 23, footprintAlpha: 0.38, interiorId: 'police-base' },
  { key: GAME_ASSETS.buildings.exteriorStreet.key, x: 17.6, y: 10.2, scale: 0.13, depth: -32, zoneId: 'rua', alpha: 0.72, originY: 0.58, footprintWidth: 370, footprintHeight: 132, footprintOffsetY: 14, footprintAlpha: 0.28 },
  { key: GAME_ASSETS.buildings.abandonedMarket.key, x: 31.8, y: 10.6, scale: 0.14, depth: -28, zoneId: 'mercado', alpha: 0.9, originY: 0.78, footprintWidth: 310, footprintHeight: 108, footprintOffsetY: 22, footprintAlpha: 0.36, interiorId: 'abandoned-market' },
  { key: GAME_ASSETS.buildings.residencePath.key, x: 32.6, y: 29.6, scale: 0.126, depth: -31, zoneId: 'caminho', alpha: 0.72, originY: 0.6, footprintWidth: 350, footprintHeight: 122, footprintOffsetY: 14, footprintAlpha: 0.26 },
  { key: GAME_ASSETS.buildings.rafaelHouse.key, x: 49.4, y: 41.6, scale: 0.142, depth: -27, zoneId: 'casa', alpha: 0.9, originY: 0.78, footprintWidth: 310, footprintHeight: 112, footprintOffsetY: 20, footprintAlpha: 0.36, interiorId: 'rafael-house' },
  { key: GAME_ASSETS.buildings.schoolGate.key, x: 58.4, y: 56.6, scale: 0.12, depth: -26, zoneId: 'escola', alpha: 0.9, originY: 0.78, footprintWidth: 300, footprintHeight: 104, footprintOffsetY: 18, footprintAlpha: 0.35 },

  { key: GAME_ASSETS.purchased.asphaltCrackedIso.key, x: 5.5, y: 8.4, scale: 1.08, depth: -49, zoneId: 'base', alpha: 0.92, originY: 0.5 },
  { key: GAME_ASSETS.purchased.asphaltRoadLineIso.key, x: 10.6, y: 9.4, scale: 1.08, depth: -49, zoneId: 'base', alpha: 0.88, originY: 0.5 },
  { key: GAME_ASSETS.purchased.asphaltCrackedIso.key, x: 14.4, y: 9.2, scale: 1.08, depth: -49, zoneId: 'rua', alpha: 0.92, originY: 0.5 },
  { key: GAME_ASSETS.purchased.asphaltRoadLineIso.key, x: 18.2, y: 10.7, scale: 1.08, depth: -49, zoneId: 'rua', alpha: 0.88, originY: 0.5 },
  { key: GAME_ASSETS.purchased.asphaltCrosswalkIso.key, x: 23.8, y: 12.2, scale: 1.08, depth: -49, zoneId: 'rua', alpha: 0.86, originY: 0.5 },
  { key: GAME_ASSETS.purchased.asphaltCrackedIso.key, x: 29.0, y: 10.2, scale: 1.08, depth: -49, zoneId: 'mercado', alpha: 0.92, originY: 0.5 },
  { key: GAME_ASSETS.purchased.asphaltRoadLineIso.key, x: 35.0, y: 13.0, scale: 1.08, depth: -49, zoneId: 'mercado', alpha: 0.86, originY: 0.5 },
  { key: GAME_ASSETS.purchased.asphaltCrackedIso.key, x: 27.2, y: 24.0, scale: 1.08, depth: -49, zoneId: 'caminho', alpha: 0.9, originY: 0.5 },
  { key: GAME_ASSETS.purchased.asphaltRoadLineIso.key, x: 34.6, y: 30.6, scale: 1.08, depth: -49, zoneId: 'caminho', alpha: 0.86, originY: 0.5 },
  { key: GAME_ASSETS.purchased.asphaltCrackedIso.key, x: 44.4, y: 39.0, scale: 1.08, depth: -49, zoneId: 'casa', alpha: 0.86, originY: 0.5 },
  { key: GAME_ASSETS.purchased.asphaltRoadLineIso.key, x: 52.0, y: 44.5, scale: 1.08, depth: -49, zoneId: 'casa', alpha: 0.84, originY: 0.5 },
  { key: GAME_ASSETS.purchased.asphaltCrackedIso.key, x: 56.2, y: 53.2, scale: 1.08, depth: -49, zoneId: 'escola', alpha: 0.88, originY: 0.5 },
  { key: GAME_ASSETS.purchased.asphaltCrosswalkIso.key, x: 60.0, y: 57.0, scale: 1.08, depth: -49, zoneId: 'escola', alpha: 0.84, originY: 0.5 },
  ...
  { key: GAME_ASSETS.purchased.wallBrokenWideA.key, x: 3.8, y: 4.2, scale: 0.13, depth: -23, zoneId: 'base', alpha: 0.78, originY: 0.88 },
  { key: GAME_ASSETS.purchased.wallBrokenWideA.key, x: 4.9, y: 3.4, scale: 0.12, depth: -23, zoneId: 'base', alpha: 0.76, originY: 0.88 },
  { key: GAME_ASSETS.purchased.streetFenceA.key, x: 3.8, y: 7.1, scale: 0.22, depth: -20, zoneId: 'base', alpha: 0.9, originY: 0.82 },
  { key: GAME_ASSETS.purchased.streetFenceA.key, x: 8.6, y: 3.6, scale: 0.22, depth: -20, zoneId: 'base', alpha: 0.88, originY: 0.82 },
  { key: GAME_ASSETS.purchased.streetBarricadeA.key, x: 10.2, y: 10.6, scale: 0.2, depth: -19, zoneId: 'base', alpha: 0.92, originY: 0.82 },
  { key: GAME_ASSETS.purchased.streetRoadClosedA.key, x: 12.1, y: 11.5, scale: 0.18, depth: -19, zoneId: 'base', alpha: 0.92, originY: 0.82 },

  { key: GAME_ASSETS.purchased.streetFenceA.key, x: 13.1, y: 5.9, scale: 0.21, depth: -20, zoneId: 'rua', alpha: 0.88, originY: 0.82 },
  { key: GAME_ASSETS.purchased.streetFenceA.key, x: 16.7, y: 5.2, scale: 0.21, depth: -20, zoneId: 'rua', alpha: 0.86, originY: 0.82 },
  { key: GAME_ASSETS.purchased.wallBrokenWideA.key, x: 18.4, y: 7.0, scale: 0.12, depth: -23, zoneId: 'rua', alpha: 0.7, originY: 0.88 },
  { key: GAME_ASSETS.purchased.streetBarricadeA.key, x: 20.6, y: 14.8, scale: 0.2, depth: -19, zoneId: 'rua', alpha: 0.9, originY: 0.82 },
  { key: GAME_ASSETS.purchased.streetRoadClosedA.key, x: 24.2, y: 10.6, scale: 0.18, depth: -19, zoneId: 'rua', alpha: 0.9, originY: 0.82 },
  { key: GAME_ASSETS.purchased.streetBenchA.key, x: 22.4, y: 6.8, scale: 0.17, depth: -19, zoneId: 'rua', alpha: 0.78, originY: 0.78 },

  { key: GAME_ASSETS.purchased.wallBrokenWideA.key, x: 28.2, y: 8.4, scale: 0.13, depth: -23, zoneId: 'mercado', alpha: 0.76, originY: 0.88 },
  { key: GAME_ASSETS.purchased.streetFenceA.key, x: 29.4, y: 7.4, scale: 0.21, depth: -20, zoneId: 'mercado', alpha: 0.86, originY: 0.82 },
  { key: GAME_ASSETS.purchased.streetFenceA.key, x: 34.8, y: 8.0, scale: 0.21, depth: -20, zoneId: 'mercado', alpha: 0.84, originY: 0.82 },
  { key: GAME_ASSETS.purchased.streetBarricadeA.key, x: 37.6, y: 13.7, scale: 0.19, depth: -19, zoneId: 'mercado', alpha: 0.9, originY: 0.82 },
  { key: GAME_ASSETS.purchased.treePineGreenA.key, x: 39.0, y: 5.8, scale: 0.38, depth: -20, zoneId: 'mercado', alpha: 0.64, originY: 0.92 },
  { key: GAME_ASSETS.purchased.streetLampA.key, x: 27.8, y: 15.6, scale: 0.18, depth: -20, zoneId: 'mercado', alpha: 0.86, originY: 0.92 },

  { key: GAME_ASSETS.purchased.wallBrokenWideA.key, x: 25.6, y: 25.8, scale: 0.12, depth: -23, zoneId: 'caminho', alpha: 0.72, originY: 0.88 },
  { key: GAME_ASSETS.purchased.streetFenceA.key, x: 30.8, y: 24.6, scale: 0.2, depth: -20, zoneId: 'caminho', alpha: 0.82, originY: 0.82 },
  { key: GAME_ASSETS.purchased.streetRoadClosedA.key, x: 35.5, y: 28.8, scale: 0.17, depth: -19, zoneId: 'caminho', alpha: 0.86, originY: 0.82 },
  { key: GAME_ASSETS.purchased.treeDeadLargeB.key, x: 40.6, y: 33.2, scale: 0.38, depth: -20, zoneId: 'caminho', alpha: 0.7, originY: 0.92 },

  { key: GAME_ASSETS.purchased.wallBrokenWideA.key, x: 45.7, y: 38.7, scale: 0.12, depth: -23, zoneId: 'casa', alpha: 0.74, originY: 0.88 },
  { key: GAME_ASSETS.purchased.streetFenceA.key, x: 47.2, y: 45.4, scale: 0.2, depth: -20, zoneId: 'casa', alpha: 0.84, originY: 0.82 },
  { key: GAME_ASSETS.purchased.streetFenceA.key, x: 52.2, y: 38.4, scale: 0.2, depth: -20, zoneId: 'casa', alpha: 0.84, originY: 0.82 },
  { key: GAME_ASSETS.purchased.streetBarricadeA.key, x: 55.2, y: 46.0, scale: 0.18, depth: -19, zoneId: 'casa', alpha: 0.86, originY: 0.82 },

  { key: GAME_ASSETS.purchased.wallBrokenWideA.key, x: 54.8, y: 51.0, scale: 0.12, depth: -23, zoneId: 'escola', alpha: 0.74, originY: 0.88 },
  { key: GAME_ASSETS.purchased.streetFenceA.key, x: 57.0, y: 51.8, scale: 0.21, depth: -20, zoneId: 'escola', alpha: 0.9, originY: 0.82 },
  { key: GAME_ASSETS.purchased.streetFenceA.key, x: 61.2, y: 55.2, scale: 0.21, depth: -20, zoneId: 'escola', alpha: 0.9, originY: 0.82 },
  { key: GAME_ASSETS.purchased.streetBarricadeA.key, x: 62.2, y: 60.2, scale: 0.18, depth: -19, zoneId: 'escola', alpha: 0.84, originY: 0.82 },

  { key: GAME_ASSETS.props.sandbagWallIso.key, x: 4.6, y: 3.8, scale: 0.54, depth: -18, zoneId: 'base', alpha: 0.9, originY: 0.8 },
  { key: GAME_ASSETS.props.sandbagWallIso.key, x: 8.8, y: 4.0, scale: 0.54, depth: -18, zoneId: 'base', alpha: 0.9, originY: 0.8 },
  { key: GAME_ASSETS.props.sandbagWallIso.key, x: 3.8, y: 8.0, scale: 0.5, depth: -18, zoneId: 'base', alpha: 0.88, originY: 0.8 },
  { key: GAME_ASSETS.props.sandbagWallIso.key, x: 9.8, y: 10.9, scale: 0.5, depth: -18, zoneId: 'base', alpha: 0.88, originY: 0.8 },
  { key: GAME_ASSETS.props.concreteBarrierIso.key, x: 11.9, y: 6.7, scale: 0.58, depth: -18, zoneId: 'base', alpha: 0.9, originY: 0.78 },
  { key: GAME_ASSETS.props.militaryCratesIso.key, x: 5.2, y: 10.6, scale: 0.48, depth: -18, zoneId: 'base', alpha: 0.86, originY: 0.83 },

  { key: GAME_ASSETS.props.sandbagWallIso.key, x: 13.8, y: 8.0, scale: 0.48, depth: -18, zoneId: 'rua', alpha: 0.84, originY: 0.8 },
  { key: GAME_ASSETS.props.concreteBarrierIso.key, x: 16.0, y: 13.8, scale: 0.54, depth: -18, zoneId: 'rua', alpha: 0.86, originY: 0.78 },
  { key: GAME_ASSETS.props.militaryCratesIso.key, x: 19.6, y: 6.2, scale: 0.44, depth: -18, zoneId: 'rua', alpha: 0.82, originY: 0.83 },
  { key: GAME_ASSETS.props.concreteBarrierIso.key, x: 24.0, y: 14.6, scale: 0.54, depth: -18, zoneId: 'rua', alpha: 0.84, originY: 0.78 },

  { key: GAME_ASSETS.props.sandbagWallIso.key, x: 28.8, y: 15.4, scale: 0.48, depth: -18, zoneId: 'mercado', alpha: 0.82, originY: 0.8 },
  { key: GAME_ASSETS.props.concreteBarrierIso.key, x: 35.8, y: 7.8, scale: 0.54, depth: -18, zoneId: 'mercado', alpha: 0.84, originY: 0.78 },
  { key: GAME_ASSETS.props.militaryCratesIso.key, x: 36.8, y: 14.4, scale: 0.44, depth: -18, zoneId: 'mercado', alpha: 0.82, originY: 0.83 },

  { key: GAME_ASSETS.props.concreteBarrierIso.key, x: 28.4, y: 26.8, scale: 0.52, depth: -18, zoneId: 'caminho', alpha: 0.78, originY: 0.78 },
  { key: GAME_ASSETS.props.sandbagWallIso.key, x: 40.4, y: 35.0, scale: 0.46, depth: -18, zoneId: 'caminho', alpha: 0.78, originY: 0.8 },
  { key: GAME_ASSETS.props.militaryCratesIso.key, x: 44.0, y: 40.4, scale: 0.42, depth: -18, zoneId: 'casa', alpha: 0.76, originY: 0.83 },
  { key: GAME_ASSETS.props.concreteBarrierIso.key, x: 53.6, y: 45.0, scale: 0.5, depth: -18, zoneId: 'casa', alpha: 0.78, originY: 0.78 },
];
